...
export function AuthLayout() {
  return (
    <div className="h-full w-full overflow-y-auto p-4 sm:p-6 bg-app bg-dots flex items-center justify-center">
      <div className="w-full max-w-5xl md:min-h-8/12 rounded-2xl border border-frame bg-surface flex flex-col md:flex-row overflow-hidden shadow-[0px_20px_60px_-15px_rgba(0,52,1,0.35)]">
