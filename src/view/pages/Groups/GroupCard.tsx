...
export function GroupCard({ group }: { group: Group }) {
    return (
        <Link
            to={`/groups/${group.id}`}
            className="rounded-xl border border-gray-200 bg-white p-4 shadow-sm flex flex-col gap-2 border-l-4 border-l-primary-500 transition-shadow hover:shadow-md"
        >
