    ...
    return (
        <>
            ...
            >
                ...
                <div className="flex flex-col gap-1">
                    <label className="text-xs text-strong" htmlFor="weekday">
                        Dia da semana
                    </label>
                    <Select
                ...
                <div className="flex flex-col gap-1">
                    <label className="text-xs text-strong" htmlFor="frequency">
                        Frequência
                    </label>
                    <Select
                ...
                <div className="flex flex-col gap-1">
                    <label className="text-xs text-strong" htmlFor="valuePerUser">
                        Valor por pessoa
                    </label>
                    <CurrencyInput
                        id="valuePerUser"
